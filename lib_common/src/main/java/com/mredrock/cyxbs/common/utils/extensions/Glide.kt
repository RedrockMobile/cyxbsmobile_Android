 ...
 */
@Deprecated("使用 utils 中的 ImageView#setImageFromUrl() 代替")
...
@Deprecated("使用 utils 中的 ImageView#setAvatarImageFromUrl() 代替", replaceWith = ReplaceWith(""))
...
@Deprecated("使用 utils 中的 FragmentActivity/Fragment#loadBitmap() 代替", replaceWith = ReplaceWith(""))
...
@Deprecated("使用 utils 中的 ImageView#setImageFromUrl() 代替", replaceWith = ReplaceWith(""))
