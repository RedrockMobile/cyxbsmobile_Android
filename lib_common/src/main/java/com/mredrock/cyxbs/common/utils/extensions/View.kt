 ...
 */
@Deprecated("使用 utils 中 View#gone() 代替", replaceWith = ReplaceWith(""))
fun View.gone() {
    visibility = View.GONE
}

@Deprecated("使用 utils 中 View#visible() 代替", replaceWith = ReplaceWith(""))
fun View.visible() {
    visibility = View.VISIBLE
}

@Deprecated("使用 utils 中 View#invisible() 代替", replaceWith = ReplaceWith(""))
fun View.invisible() {
 ...
 * @param click 具体的点击事件
 */
@Deprecated("使用 utils 中的 View#setOnSingleClickListener() 代替")
