...
import com.cyxbs.pages.notification.bean.*
...
interface ApiService {
    ...
    * */
    ...
    fun deleteMsg(@Body deleteBody: DeleteMsgToBean):
            Observable<ApiWrapper<DeleteMsgFromBean>>
    ...
    fun changeMsgStatus(@Body changeBody: ChangeReadStatusToBean):
            Observable<ApiWrapper<ChangeReadStatusFromBean>>

    /**
     * 检查是否签到
     */
    @POST("/magipoke-intergral/QA/User/getScoreStatus")
    fun getCheckInStatus(): Observable<ApiWrapper<ScoreStatus>>
