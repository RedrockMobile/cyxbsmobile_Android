package com.cyxbs.pages.home.widget
...
class BottomNavLayout(
  ...
  private val mChild = LayoutInflater.from(context).inflate(R.layout.home_bottom_nav, this)
  ...
  fun setBtnSelector(position: Int, showNormal: Boolean) {
    ...
    when(position) {
      2 ->{
        if (!showNormal)
          mBtnList[position].setCompoundDrawablesWithIntrinsicBounds(null, R.drawable.home_selector_bottom_mine_red_dot.drawable,null,null)
        else
          mBtnList[position].setCompoundDrawablesWithIntrinsicBounds(null, R.drawable.home_selector_bottom_mine.drawable,null,null)
      }
