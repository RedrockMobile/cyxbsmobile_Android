package com.cyxbs.pages.store.page.center.ui.fragment
...
import com.cyxbs.pages.store.page.center.ui.item.SmallShopProductItem
import com.cyxbs.pages.store.page.center.ui.item.SmallShopTitleItem
    ...
    private fun setAdapter(stampCount: Int) {
        ...
        layoutManager.spanSizeLookup = object : GridLayoutManager.SpanSizeLookup() {
            override fun getSpanSize(position: Int): Int =
                if (titleMap.containsKey(position)) 2 else 1
        }
