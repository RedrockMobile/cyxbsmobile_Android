package com.cyxbs.pages.course.widget.item.view
...
abstract class CommonLessonView(context: Context) : ItemView(context) {
  ...
  protected open val mAmTextColor = R.color.course_widget_am_lesson_tv.color
  protected open val mPmTextColor = R.color.course_widget_pm_lesson_tv.color
  protected open val mNightTextColor = R.color.course_widget_night_lesson_tv.color
  protected open val mAmBgColor = R.color.course_widget_am_lesson_bg.color
  protected open val mPmBgColor = R.color.course_widget_pm_lesson_bg.color
  protected open val mNightBgColor = R.color.course_widget_night_lesson_bg.color
