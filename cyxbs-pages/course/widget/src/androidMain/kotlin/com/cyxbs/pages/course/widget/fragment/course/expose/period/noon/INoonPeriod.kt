package com.cyxbs.pages.course.widget.fragment.course.expose.period.noon
...
interface INoonPeriod {
   ...
   */
  fun compareNoonPeriodByRow(row: Int): Int
  
  /**
   * 同 [compareNoonPeriodByRow]，但比较的是高度 [height]
   */
  fun compareNoonPeriodByHeight(height: Int): Int
