 ...
 */
class InsecureSHA1PRNGKeyDerivator private constructor() {
  ...
  companion object {
    ...
    private fun updateHash(intArray: IntArray, byteInput: ByteArray, fromByte: Int, toByte: Int) {
      ...
      // writing full words
      val maxWord = (toByte - i + 1) shr 2 // # of remaining full words, may be "0"
